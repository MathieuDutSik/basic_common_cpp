...
#ifndef SRC_NUMBER_MPREAL_RELATED_H_
#define SRC_NUMBER_MPREAL_RELATED_H_

#include "mpreal.h"
// If we are using mpreal, then somehow, we are forced to use mpq_class and
// mpz_class Those are just too related. However we included only the strictly
// necessary.
#include "gmpxx.h"
