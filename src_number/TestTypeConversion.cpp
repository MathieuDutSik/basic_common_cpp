...
int main() {
  ...
  for (int i_int = 0; i_int < 10; i_int++) {
    ...
    T_uint64_t val_64_2 = UniversalScalarConversion<T_uint64_t, mpz_class>(val_mpz);
    ...
    mpz_class val_mpz_2 = UniversalScalarConversion<mpz_class,T_uint64_t>(val_uint64_t);
