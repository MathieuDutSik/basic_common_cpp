...
// long as input (the boost::multiprecision::cpp_rational and cpp_int
...
inline void cpp_int_to_small_integer(boost::multiprecision::cpp_int const &val,
                                     Tout &out) {
...
// cpp_rational as output target for the small integer types
