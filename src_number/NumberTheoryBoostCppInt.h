...
inline boost::multiprecision::cpp_int GetDenominator([[maybe_unused]] boost::multiprecision::cpp_int const& x)
{
  return 1;
}
...
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_int> const& a1, double & a2)
{
  a2 = a1.val.template convert_to<double>();
  //  std::cerr << "Missing code, write here\n";
  //  throw TerminalException{1};
}
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_int> const& a1, int & a2)
{
  a2 = a1.val.template convert_to<int>();
}
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_int> const& a1, long & a2)
{
  a2 = a1.val.template convert_to<long>();
}
inline void TYPE_CONVERSION(stc<int> const& a1, boost::multiprecision::cpp_int & a2)
{
  a2 = a1.val;
}
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_int> const& a1, boost::multiprecision::cpp_int & a2)
{
  a2 = a1.val;
}


inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_rational> const& a1, double & a2)
{
  a2 = a1.val.template convert_to<double>();
  //  std::cerr << "Missing code, write here\n";
  //  throw TerminalException{1};
}
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_rational> const& a1, boost::multiprecision::cpp_int & a2)
{
  if (!IsInteger(a1.val)) {
...
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_rational> const& a1, int & a2)
{
...
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_rational> const& a1, long & a2)
{
  boost::multiprecision::cpp_int a1_z;
  TYPE_CONVERSION(a1, a1_z);
  stc<boost::multiprecision::cpp_int> stc_a1_z{a1_z};
...
inline void TYPE_CONVERSION(stc<int> const& a1, boost::multiprecision::cpp_rational & a2)
{
  a2 = a1.val;
}
inline void TYPE_CONVERSION(stc<long> const& a1, boost::multiprecision::cpp_rational & a2)
{
  a2 = a1.val;
}
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_int> const& a1, boost::multiprecision::cpp_rational & a2)
{
  a2 = a1.val;
}
inline void TYPE_CONVERSION(stc<boost::multiprecision::cpp_rational> const& a1, boost::multiprecision::cpp_rational & a2)
{
  a2 = a1.val;
}
