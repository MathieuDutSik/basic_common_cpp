...
template <class Archive, typename T>
inline void serialize(Archive &ar, std::unordered_set<T> &val,
...
template <class Archive, typename K, typename V>
inline void serialize(Archive &ar, std::unordered_map<K, V> &val,
                      const unsigned int version) {
  split_free(ar, val, version);
}
...
template <class Archive, typename T>
inline void serialize(Archive &ar, std::optional<T> &val,
                      const unsigned int version) {
  split_free(ar, val, version);
}
