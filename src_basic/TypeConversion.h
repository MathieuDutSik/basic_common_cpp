...
inline void TYPE_CONVERSION(double & a1, double & a2)
{
  a2 = a1;
}

inline void TYPE_CONVERSION(double & a1, uint8_t & a2)
{
  a2 = uint8_t(a1);
}

inline void TYPE_CONVERSION(double & a1, int & a2)
{
  a2 = int(a1);
}

inline void TYPE_CONVERSION(double & a1, long & a2)
{
  a2 = long(a1);
}
...
inline void TYPE_CONVERSION(int & a1, double & a2)
{
  a2 = double(a1);
}

inline void TYPE_CONVERSION(uint8_t & a1, double & a2)
{
  a2 = double(a1);
}
...
inline void TYPE_CONVERSION(long & a1, double & a2)
{
  a2 = double(a1);
}
...
template<typename To, typename Ti>
inline typename std::enable_if<(not std::is_same_v<Ti,double>),To>::type UniversalNearestScalarInteger(Ti const& a)
{
  To ret;
...
template<typename To, typename Ti>
inline typename std::enable_if<std::is_same_v<Ti,double>,To>::type UniversalNearestScalarInteger(Ti const& a)
{
  To ret;
