...
// POSIX-only: runs an external program in a child process. Relies on
// fork / execvp / waitpid, none of which are available in WebAssembly.
// Keep this in its own header so the rest of src_basic compiles on Wasm.
