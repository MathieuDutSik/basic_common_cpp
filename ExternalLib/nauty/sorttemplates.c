...
#define SORT_SWAP1(x, y)                                                       \
  tmp1 = x;                                                                    \
  x = y;                                                                       \
  y = tmp1;
#define SORT_SWAP2(x, y)                                                       \
  tmp2 = x;                                                                    \
  x = y;                                                                       \
  y = tmp2;
...
SORT_NAME(SORT_TYPE1 *x, SORT_TYPE2 *y, int n) {
  ...
  while (top > 0) {
    ...
    if (nn < SORT_MINMEDIAN9)
      ...
      v2 =
          SORT_MEDIAN_OF_3(y[x0[nn / 2 - 1]], y[x0[nn / 2]], y[x0[nn / 2 + 1]]);
...
SORT_NAME(SORT_TYPE1 *x, int n) {
  ...
  while (top > 0) {
    ...
    if (nn < SORT_MINMEDIAN9)
      ...
      v2 = F_SORT_MEDIAN_OF_3(SORT_COMPARE, x0[nn / 2 - 1], x0[nn / 2],
                              x0[nn / 2 + 1]);
