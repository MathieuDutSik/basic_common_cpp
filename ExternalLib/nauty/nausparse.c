...
dispatchvec dispatch_sparse = {
    isautom_sg,      testcanlab_sg, updatecan_sg,  refine_sg,
    refine_sg,       cheapautom_sg, targetcell_sg, nausparse_freedyn,
    nausparse_check, init_sg,       NULL};
...
#if !MAXN
static void preparemarks1(size_t nn) {
  size_t oldsize;
  short *oldpos;
  ...
  if (vmark1_sz != oldsize || vmark1 != oldpos)
    vmark1_val = 32000;
}
#endif

#if !MAXN
static void preparemarks2(size_t nn) {
  size_t oldsize;
  short *oldpos;
  ...
  if (vmark2_sz != oldsize || vmark2 != oldpos)
    vmark2_val = 32000;
}
#endif
...
boolean isautom_sg(graph *g, int *p, boolean digraph, int m, int n) {
  int *d, *e;
  size_t *v;
  int i, pi, di;
  size_t vi, vpi, j;
...
boolean aresame_sg(sparsegraph *g1, sparsegraph *g2) {
  int *d1, *e1;
  int *d2, *e2;
  int n, i, di;
  size_t vi, *v1, *v2, j;
...
int testcanlab_sg(graph *g, graph *canong, int *lab, int *samerows, int m,
                  int n) {
  int *d, *e;
  int *cd, *ce;
  int i, k, di, dli;
...
void updatecan_sg(graph *g, graph *canong, int *lab, int samerows, int m,
                  int n) {
  int *d, *e;
  int *cd, *ce;
  int i, dli;
...
int comparelab_tr(sparsegraph *g, int *lab1, int *invlab1, int *lab2,
                  int *invlab2, int *cls, int *col) {
  int d1, *e1, d2, *e2;
  int i, j, k, n, c, end;
  int mina;
...
int testcanlab_tr(sparsegraph *g, sparsegraph *canong, int *lab, int *invlab,
                  int *samerows) {
  int *d, *e;
  int *cd, *ce;
  int i, di, dli;
...
void updatecan_tr(sparsegraph *g, sparsegraph *canong, int *lab, int *invlab,
                  int samerows) {
  int *d, *e;
  int *cd, *ce;
  int i, dli, n;
...
void init_sg(graph *gin, graph **gout, graph *hin, graph **hout, int *lab,
...
void cleanup_sg(graph *gin, graph **gout, graph *hin, graph **hout, int *lab,
...
void refine_sg(graph *g, int *lab, int *ptn, int level, int *numcells,
...
static int bestcell_sg(graph *g, int *lab, int *ptn, int level, int tc_level,
                       int m, int n) {
  int nnt;
  int *d, *e;
  int i, k, di;
...
int targetcell_sg(graph *g, int *lab, int *ptn, int level, int tc_level,
...
void sortlists_sg(sparsegraph *g) {
  int *d, *e;
  int n, i;
  size_t *v;
  sg_weight *wt;
...
void put_sg(FILE *f, sparsegraph *sg, boolean digraph, int linelength) {
  int *d, *e;
  int n, di;
  int i, curlen, slen;
  size_t *v, vi, j;
...
graph *sg_to_nauty(sparsegraph *sg, graph *g, int reqm, int *pm) {
  int *d, *e;
  int m, n, i, di;
  size_t *v, vi, j;
  set *gi;
...
sparsegraph *copy_sg(sparsegraph *sg1, sparsegraph *sg2) {
  int *d1, *e1, *d2, *e2;
  int i, n;
  size_t *v1, *v2, k;
  sg_weight *wt1, *wt2;
  ...
  if (wt1)
    memcpy(wt2, wt1, k * sizeof(sg_weight));
...
sparsegraph *nauty_to_sg(graph *g, sparsegraph *sg, int m, int n) {
  int *d, *e;
  int i, k;
  set *gi;
  size_t j, *v, nde;
...
void distances_sg(graph *g, int *lab, int *ptn, int level, int numcells,
...
void adjacencies_sg(graph *g, int *lab, int *ptn, int level, int numcells,
                    int tvpos, int *invar, int invararg, boolean digraph, int m,
                    int n) {
  int *d, *e;
  int vwt, wwt;
...
void sparsenauty(sparsegraph *g, int *lab, int *ptn, int *orbits,
  ...
  nauty((graph *)g, lab, ptn, NULL, orbits, options, stats, snwork, 2 * 60 * m,
        m, n, (graph *)h);
}
...
void nausparse_check(int wordsize, int m, int n, int version) {
