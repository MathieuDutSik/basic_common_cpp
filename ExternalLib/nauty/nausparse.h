...
#define CHECK_SWG(sg, id)                                                      \
  do {                                                                         \
    if ((sg)->w) {                                                             \
      fprintf(stderr, ">E procedure %s does not accept weighted graphs\n",     \
              id);                                                             \
      exit(1);                                                                 \
    }                                                                          \
  } while (0)
...
#define SG_VDE(sgp, vv, dd, ee)                                                \
  do {                                                                         \
    vv = ((sparsegraph *)(sgp))->v;                                            \
    dd = ((sparsegraph *)(sgp))->d;                                            \
    ee = ((sparsegraph *)(sgp))->e;                                            \
  } while (0)
#define SWG_VDE(sgp, vv, dd, ee, ww)                                           \
  do {                                                                         \
    vv = ((sparsegraph *)(sgp))->v;                                            \
    dd = ((sparsegraph *)(sgp))->d;                                            \
    ee = ((sparsegraph *)(sgp))->e;                                            \
    ww = ((sparsegraph *)(sgp))->w;                                            \
  } while (0)
#define SG_INIT(sg)                                                            \
  do {                                                                         \
    (sg).v = NULL;                                                             \
    (sg).d = (sg).e = (sg).w = NULL;                                           \
    (sg).vlen = (sg).dlen = (sg).elen = (sg).wlen = 0;                         \
  } while (0)
#define SWG_INIT SG_INIT
#define SG_ALLOC(sg, nlen, ndelen, msg)                                        \
  do {                                                                         \
    DYNALLOC1(size_t, (sg).v, (sg).vlen, nlen, msg);                           \
    DYNALLOC1(int, (sg).d, (sg).dlen, nlen, msg);                              \
    DYNALLOC1(int, (sg).e, (sg).elen, ndelen, msg);                            \
  } while (0)
#define SWG_ALLOC(sg, nlen, ndelen, msg)                                       \
  do {                                                                         \
    DYNALLOC1(size_t, (sg).v, (sg).vlen, nlen, msg);                           \
    DYNALLOC1(int, (sg).d, (sg).dlen, nlen, msg);                              \
    DYNALLOC1(int, (sg).e, (sg).elen, ndelen, msg);                            \
...
#define DEFAULTOPTIONS_SPARSEGRAPH(options)                                    \
  optionblk options = {0,                                                      \
                       FALSE,                                                  \
                       FALSE,                                                  \
                       FALSE,                                                  \
                       ...
                       FALSE,                                                  \
                       NULL}
#define DEFAULTOPTIONS_SPARSEDIGRAPH(options)                                  \
  optionblk options = {0,                                                      \
                       TRUE,                                                   \
                       FALSE,                                                  \
                       FALSE,                                                  \
...
extern int targetcell_sg(graph *, int *, int *, int, int, boolean, int, int,
                         int);
extern boolean cheapautom_sg(int *, int, boolean, int);
extern boolean isautom_sg(graph *, int *, boolean, int, int);
extern void refine_sg(graph *, int *, int *, int, int *, int *, set *, int *,
                      int, int);
...
extern int comparelab_tr(sparsegraph *, int *, int *, int *, int *, int *,
                         int *);
...
extern void cleanup_sg(graph *, graph **, graph *, graph **, int *, int *,
                       optionblk *, statsblk *stats, int, int);
...
extern void sparsenauty(sparsegraph *g, int *, int *, int *, optionblk *,
                        statsblk *, sparsegraph *);

extern void adjacencies_sg(graph *, int *, int *, int, int, int, int *, int,
                           boolean, int, int);
extern void distances_sg(graph *, int *, int *, int, int, int, int *, int,
                         boolean, int, int);
extern void distances_sg(graph *, int *, int *, int, int, int, int *, int,
                         boolean, int, int);
